...
DROP TABLE IF EXISTS `algorithm_example`;

CREATE TABLE `algorithm_example` (
...
/*Data for the table `algorithm_tag_relation` */

insert  into `algorithm_tag_relation`(`rid`,`pid`,`tid`) values (NULL,1,3);

/*Table structure for table `algorithm_true_code` */

DROP TABLE IF EXISTS `algorithm_true_code`;

CREATE TABLE `algorithm_true_code` (
...
/*Data for the table `algorithm_true_code` */
